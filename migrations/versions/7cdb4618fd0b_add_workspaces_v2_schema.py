...
def upgrade() -> None:
    ...
    sa.Column('writable', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('lockable', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('is_git_repo', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('repo_url', sa.Text(), nullable=True),
    sa.Column('default_lock_mode', sa.Text(), nullable=True),
    sa.Column('auto_attach', sa.Boolean(), server_default='false', nullable=False),
