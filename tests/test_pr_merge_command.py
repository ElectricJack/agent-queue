...
@pytest.mark.asyncio
async def test_pr_diff_fetch_cannot_fall_back_to_login_when_app_is_configured(monkeypatch):
    ...
    with pytest.raises(GitError, match="App-authenticated PR commit fetch"):
