...
commit the generated merge revision. If two migrations have the same revision
ID, give the later migration a unique ID and chain it after the earlier one.
Duplicate IDs anywhere in the chain are errors, even if there is only one head.
"""
