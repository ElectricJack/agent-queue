...
**Integration Rebind Reused Identity.** Authenticated hierarchical integration operational control.

| Property | Value |
|---|---|
| Capability | `integration_rebind_reused_identity` |
| Side effect | `update` |
| Idempotency | natural |
| Retry safe | yes |
| Timeout | none |
...
| Contract fingerprint | `sha256:52734026648038fe58090fbf967f564e3b1be07a39cda7b78b3c79e6bdeded12` |
...
| `expected_origin_ids` | `string[]` | no | `[]` | — |
| `discard_tips` | `string[]` | no | `[]` | — |
