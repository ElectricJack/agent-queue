...
**Integration Adopt Legacy Deliveries.** Authenticated hierarchical integration operational control.

| Property | Value |
|---|---|
| Capability | `integration_adopt_legacy_deliveries` |
| Side effect | `create` |
| Idempotency | natural |
| Retry safe | yes |
| Timeout | none |
