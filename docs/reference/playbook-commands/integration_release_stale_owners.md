...
**Integration Release Stale Owners.** Authenticated hierarchical integration operational control.

| Property | Value |
|---|---|
| Capability | `integration_release_stale_owners` |
| Side effect | `update` |
| Idempotency | natural |
| Retry safe | yes |
| Timeout | none |
...
| Contract fingerprint | `sha256:aa8f0b413a69681a73b350eb1ba55b8c809791e9b228dc95c6f9a5a236a6de2b` |
...
| `older_than` | `string \| null` | no | `null` | — |
