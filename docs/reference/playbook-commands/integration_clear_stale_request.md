...
**Integration Clear Stale Request.** Authenticated hierarchical integration operational control.

| Property | Value |
|---|---|
| Capability | `integration_clear_stale_request` |
| Side effect | `update` |
| Idempotency | natural |
| Retry safe | yes |
| Timeout | none |
...
| `expected_request_id` | `string \| null` | no | `null` | — |
