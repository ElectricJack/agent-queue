...
**Integration Reserve Owner.** Authenticated hierarchical integration operational control.

| Property | Value |
|---|---|
| Capability | `integration_reserve_owner` |
| Side effect | `update` |
| Idempotency | natural |
| Retry safe | yes |
| Timeout | none |
...
| Contract fingerprint | `sha256:0629ea0bc296352ec34793ceb51ac2cabfc9af532952a144b0679e2e248054de` |
