...
| [src/config_secrets.py](../../../src/config_secrets.py) | Redacts literal credentials from configuration reads and restores retained placeholders safely on writes. | [Configuration reference](../configuration.md) | tests/test_config_secrets.py |
