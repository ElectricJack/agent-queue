...
| [src/config_secrets.py](../../../src/config_secrets.py) | Redacts literal configuration secrets on reads and restores retained placeholders only for safe writes. | [Configuration reference](../configuration.md) | tests/test_config_secrets.py |
