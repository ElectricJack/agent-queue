...
> the PostgreSQL steps and the optional agent CLI steps ship today. WSL and
> Homebrew installation remain adapter work; `aq install --list-steps` always
> prints what this build actually knows how to do.
