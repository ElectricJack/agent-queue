...
RULES: list[tuple[str, str, str, str, str]] = [
    ...
    *_owned_page_rules(),
    ...
    ("src/config_secrets.py", "vault", "docs/reference/configuration.md",
     PRODUCTION, "Read-side configuration secret redaction and safe placeholder restoration."),
    ...
    ("src/remote_links.py", "operations", "docs/guides/operations.md", PRODUCTION,
     "Resolves a safe non-loopback dashboard URL for remote operator links."),
