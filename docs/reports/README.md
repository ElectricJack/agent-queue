...
| [`provider-failover-e2e-2026-09-21/`](provider-failover-e2e-2026-09-21/README.md) | 2026-09-21 | The end-to-end acceptance run of provider failover (`bold-rapids.5`): the Tier 1 kit's S16 against two fake providers, its [transcript](provider-failover-e2e-2026-09-21/transcript.txt), dashboard screenshots taken during a staged outage, and the findings the run surfaced. |
