...
2. Run `aq doctor --check integration.operational --check integration.stranded_fences --check integration.stranded_delegates --check integration.branch_discards --check integration.finished_branch_owners`.
