  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4"
      ...
      <div ref={dialog} role="dialog" aria-modal="true" aria-labelledby={id + "-title"} aria-describedby={id + "-effect"}
        ...
        className="flex max-h-[90dvh] w-full max-w-3xl flex-col rounded-lg border border-gray-700 bg-gray-900 shadow-2xl">
        ...
        <form onSubmit={(event) => { event.preventDefault(); void save(); }} noValidate className="flex min-h-0 flex-1 flex-col">
          <fieldset disabled={edit.isPending} className="min-h-0 flex-1 space-y-5 overflow-y-auto px-6 py-5 disabled:opacity-70">
          ...
          <footer className="flex justify-end gap-2 border-t border-gray-700 px-6 py-3">
