...
export default function ActivationPanel({ artifact, activation, executableChange, onActivate, artifacts = [], selectedSha, onSelect }: { artifact: Artifact; activation: Activation; executableChange: boolean; onActivate: (sha: string) => void; artifacts?: ArtifactSummary[]; selectedSha?: string; onSelect?: (sha: string) => void }) {
