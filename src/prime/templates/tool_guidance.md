...
`ask_human`, `message_send`, `message_inbox`, `memory_save`, `memory_search`. Use whichever
of the two paths (CLI or native tool) is more convenient — both hit the same command handler
