...
def _vault_profile_path(data_dir: str, profile_id: str) -> str:
    ...
    Profiles are global, one folder per agent type:
    ``vault/agent-types/<id>/profile.md``.  The retired project-scoped form
    is handled by :mod:`src.profiles.project_override_migration`, which
    promotes it here and deletes it.
    """
