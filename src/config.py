...
class MemoryConfig:
    ...
    index_project_docs: bool = True  # index individual doc files (AGENTS.md, CLAUDE.md, README.md)
    project_docs_files: tuple[str, ...] = ("AGENTS.md", "CLAUDE.md", "README.md")  # files to index individually
