...
and returns an actionable fix suggestion for dashboard and log consumers. The
legacy interactive Discord views were removed by the single-channel cutover.
"""
