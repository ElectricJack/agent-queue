...
class DatabaseBackend(Protocol):
    ...
    async def list_slots_for_base(
        self, base_workspace_id: str
    ) -> list[Workspace]: ...
    ...
    async def count_events_after(
        self, seq: int, *, event_type: str, project_id: str
    ) -> int: ...
