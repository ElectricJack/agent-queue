...
integration_promotion_intents = Table(
    ...
    # Committed immediately before the resolution's only external push.  It
    # distinguishes a never-started write from a possibly in-flight one.
...
integration_candidate_resolutions = Table(
    ...
    Column("operation_episode_id", Text, nullable=False),
    Column("stage_ordinal", Integer, nullable=False),
    Column("stage_deadline_at", Float, nullable=False),
    Column("project_id", Text, nullable=False),
...
integration_candidate_ref_mutations = Table(
    ...
    Column("revision", Integer, nullable=False),
    Column("member_ordinal", Integer, nullable=True),
    Column("resolution_id", Text, nullable=True),
    Column("purpose", Text, nullable=False),
    Column("repository_id", Text, nullable=False),
    Column("branch", Text, nullable=False),
    Column("target_branch", Text, nullable=False),
    Column("expected_old_sha", Text, nullable=False),
    Column("desired_sha", Text, nullable=False),
    Column("operation_id", Text, nullable=False),
    Column("operation_episode_id", Text, nullable=False),
    Column("operation_stage", Integer, nullable=False),
    Column("lease_owner_id", Text, nullable=False),
    Column("lease_fence_token", Integer, nullable=False),
    Column("branch_owner_id", Text, nullable=False),
    Column("branch_owner_role", Text, nullable=False),
    Column("branch_fence_token", Integer, nullable=False),
