...
def sync_detailed(
    *,
    ...
    discord_channel_id, default_profile_id, assignment_playbook_id, repo_default_branch, or LOCAL-only
    hierarchical integration configuration. Use this to rename projects, adjust scheduling weight, set
    token budgets, link Discord channels, set a default agent profile, or change the default git branch.
