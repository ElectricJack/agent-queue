...
) -> AgentSummary | CreateAgentResponse422 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AgentSummary | CreateAgentResponse422]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Define a shared worker without launching it. Requires global admin.
...
def sync(
    *,
    ...
    Returns:
        AgentSummary | CreateAgentResponse422
    """
