...
from ...models.job_list_args import JobListArgs
...
) -> JobErrorResponse | JobListResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[JobErrorResponse | JobListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List this owner's managed jobs.
...
def sync(
    *,
    ...
    Returns:
        JobErrorResponse | JobListResponse
    """
