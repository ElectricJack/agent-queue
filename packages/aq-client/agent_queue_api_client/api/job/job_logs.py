...
from ...models.job_logs_args import JobLogsArgs
...
) -> JobErrorResponse | JobLogsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[JobErrorResponse | JobLogsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Read retained output ranges with explicit gaps.
...
def sync(
    *,
    ...
    Returns:
        JobErrorResponse | JobLogsResponse
    """
