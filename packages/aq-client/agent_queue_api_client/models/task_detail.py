...
class TaskDetail:
    ...
    Attributes:
        ...
        parent (None | TaskDetailParentType0 | Unset):
        children (None | TaskDetailChildrenType0 | Unset):
    ...
    parent: None | TaskDetailParentType0 | Unset = UNSET
    children: None | TaskDetailChildrenType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.task_detail_children_type_0 import TaskDetailChildrenType0  # noqa: PLC0415
        from ..models.task_detail_parent_type_0 import TaskDetailParentType0  # noqa: PLC0415
        ...
        if isinstance(self.parent, Unset):
            parent = UNSET
        elif isinstance(self.parent, TaskDetailParentType0):
        ...
        if isinstance(self.children, Unset):
            children = UNSET
        elif isinstance(self.children, TaskDetailChildrenType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_parent(data: object) -> None | TaskDetailParentType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                parent_type_0 = TaskDetailParentType0.from_dict(data)

                return parent_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TaskDetailParentType0 | Unset, data)

        parent = _parse_parent(d.pop("parent", UNSET))

        def _parse_children(data: object) -> None | TaskDetailChildrenType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                children_type_0 = TaskDetailChildrenType0.from_dict(data)

                return children_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TaskDetailChildrenType0 | Unset, data)
