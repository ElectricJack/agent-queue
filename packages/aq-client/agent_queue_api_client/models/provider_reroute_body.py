...
T = TypeVar("T", bound="ProviderRerouteBody")


@_attrs_define
class ProviderRerouteBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_reroute_body.additional_properties = d
        return provider_reroute_body
