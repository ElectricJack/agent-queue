...
T = TypeVar("T", bound="ListMcpToolCatalogResponseServers")
...
class ListMcpToolCatalogResponseServers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_mcp_tool_catalog_response_servers.additional_properties = additional_properties
        return list_mcp_tool_catalog_response_servers
