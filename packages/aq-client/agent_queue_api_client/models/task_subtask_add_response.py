...
T = TypeVar("T", bound="TaskSubtaskAddResponse")


@_attrs_define
class TaskSubtaskAddResponse:
    """
    Attributes:
        task_id (str):
        success (bool | Unset):  Default: True.
        subtasks (list[TaskSubtaskWithContext] | Unset):
    """

    task_id: str
    success: bool | Unset = True
    subtasks: list[TaskSubtaskWithContext] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _subtasks is not UNSET:
            ...
            for subtasks_item_data in _subtasks:
                subtasks_item = TaskSubtaskWithContext.from_dict(subtasks_item_data)

                subtasks.append(subtasks_item)

        task_subtask_add_response = cls(
            task_id=task_id,
            success=success,
            subtasks=subtasks,
        )

        task_subtask_add_response.additional_properties = d
        return task_subtask_add_response
