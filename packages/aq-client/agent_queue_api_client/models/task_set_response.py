...
class TaskSetResponse:
    ...
    Attributes:
        ...
        deliverables (list[TaskSetResponseDeliverablesItem] | Unset):
    ...
    deliverables: list[TaskSetResponseDeliverablesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _deliverables is not UNSET:
            ...
            for deliverables_item_data in _deliverables:
                deliverables_item = TaskSetResponseDeliverablesItem.from_dict(deliverables_item_data)
