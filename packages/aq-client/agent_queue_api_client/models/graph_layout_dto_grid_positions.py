...
T = TypeVar("T", bound="GraphLayoutDTOGridPositions")


@_attrs_define
class GraphLayoutDTOGridPositions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        graph_layout_dto_grid_positions = cls()
        ...
        graph_layout_dto_grid_positions.additional_properties = additional_properties
        return graph_layout_dto_grid_positions
