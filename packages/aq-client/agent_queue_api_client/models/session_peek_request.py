...
T = TypeVar("T", bound="SessionPeekRequest")


@_attrs_define
class SessionPeekRequest:
    """
    Attributes:
        ...
        lines (int | None | Unset): Number of tail lines to return (default 60)
        n (int | None | Unset): Alias for lines
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_lines(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        session_peek_request.additional_properties = d
        return session_peek_request
