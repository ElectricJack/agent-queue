...
from ..models.compiler_diagnostic_dto_severity import CompilerDiagnosticDTOSeverity
...
T = TypeVar("T", bound="CompilerDiagnosticDTO")


@_attrs_define
class CompilerDiagnosticDTO:
    """
    Attributes:
        severity (CompilerDiagnosticDTOSeverity):
        code (str):
        message (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        severity = CompilerDiagnosticDTOSeverity(d.pop("severity"))
        ...
        return compiler_diagnostic_dto
