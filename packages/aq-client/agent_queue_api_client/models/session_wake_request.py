...
T = TypeVar("T", bound="SessionWakeRequest")


@_attrs_define
class SessionWakeRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_wake_request.additional_properties = d
        return session_wake_request
