...
T = TypeVar("T", bound="UpdatePlaybookSourceRequest")


@_attrs_define
class UpdatePlaybookSourceRequest:
    """
    Attributes:
        playbook_id (str): The playbook identifier.
        markdown (str): Full markdown content including YAML frontmatter.
        expected_source_hash (None | str | Unset): Content hash the caller last saw (from get_playbook_source). When
            provided, the update is rejected with a conflict error if the vault copy has changed underneath.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_playbook_source_request = cls(
            playbook_id=playbook_id,
            markdown=markdown,
            expected_source_hash=expected_source_hash,
        )

        update_playbook_source_request.additional_properties = d
        return update_playbook_source_request
