...
class GetTaskResponse:
    ...
    Attributes:
        ...
        deliverables (list[GetTaskResponseDeliverablesItem] | Unset):
    ...
    deliverables: list[GetTaskResponseDeliverablesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _deliverables is not UNSET:
            ...
            for deliverables_item_data in _deliverables:
                deliverables_item = GetTaskResponseDeliverablesItem.from_dict(deliverables_item_data)
