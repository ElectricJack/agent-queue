...
T = TypeVar("T", bound="ProviderSetStateRequest")


@_attrs_define
class ProviderSetStateRequest:
    """
    Attributes:
        provider (str): Provider key (claude, codex) or vendor alias.
        state (str): disabled | available | auto (clear the override).
        reason (None | str | Unset): Why; required for disabled and available.
        for_ (None | str | Unset): How long the override lasts: 90s, 30m, 4h, 2d, or seconds.
        until (None | str | Unset): When the override expires: epoch seconds or ISO-8601.
        no_expiry (bool | None | Unset): Never expire (disabled only).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_set_state_request = cls(
            provider=provider,
            state=state,
            reason=reason,
            for_=for_,
        ...
        provider_set_state_request.additional_properties = d
        return provider_set_state_request
