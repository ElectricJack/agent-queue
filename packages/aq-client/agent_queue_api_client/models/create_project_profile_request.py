...
if TYPE_CHECKING:
    from ..models.create_project_profile_request_install_type_0 import CreateProjectProfileRequestInstallType0


T = TypeVar("T", bound="CreateProjectProfileRequest")
...
class CreateProjectProfileRequest:
    ...
    Attributes:
        project_id (str):
        agent_type (str):
        seed_from_global (bool | Unset):  Default: True.
        name (None | str | Unset):
        ...
        install (CreateProjectProfileRequestInstallType0 | None | Unset):
    """

    project_id: str
    agent_type: str
    seed_from_global: bool | Unset = True
    ...
    install: CreateProjectProfileRequestInstallType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.create_project_profile_request_install_type_0 import (
            CreateProjectProfileRequestInstallType0,  # noqa: PLC0415
        )
        ...
        seed_from_global = self.seed_from_global
        ...
        if isinstance(self.install, Unset):
            install = UNSET
        elif isinstance(self.install, CreateProjectProfileRequestInstallType0):
        ...
        if seed_from_global is not UNSET:
            field_dict["seed_from_global"] = seed_from_global
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        seed_from_global = d.pop("seed_from_global", UNSET)
        ...
        def _parse_install(data: object) -> CreateProjectProfileRequestInstallType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                install_type_0 = CreateProjectProfileRequestInstallType0.from_dict(data)

                return install_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateProjectProfileRequestInstallType0 | None | Unset, data)

        install = _parse_install(d.pop("install", UNSET))

        create_project_profile_request = cls(
            project_id=project_id,
            agent_type=agent_type,
            seed_from_global=seed_from_global,
            name=name,
        ...
        create_project_profile_request.additional_properties = d
        return create_project_profile_request
