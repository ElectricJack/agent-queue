...
T = TypeVar("T", bound="GitRemoteUrlRequest")


@_attrs_define
class GitRemoteUrlRequest:
    """
    Attributes:
        project_id (None | str | Unset): Project ID
        remote (str | Unset): Remote name (default: origin) Default: 'origin'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        git_remote_url_request = cls(
            project_id=project_id,
            remote=remote,
            workspace=workspace,
        )

        git_remote_url_request.additional_properties = d
        return git_remote_url_request
