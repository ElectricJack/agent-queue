...
T = TypeVar("T", bound="SessionSleepRequest")


@_attrs_define
class SessionSleepRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_sleep_request.additional_properties = d
        return session_sleep_request
