...
T = TypeVar("T", bound="SessionLogsRequest")
...
class SessionLogsRequest:
    ...
    Attributes:
        ...
        limit (int | None | Unset): Max transcript entries to return (default 100)
        lines (int | None | Unset): Alias for limit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_logs_request.additional_properties = d
        return session_logs_request
