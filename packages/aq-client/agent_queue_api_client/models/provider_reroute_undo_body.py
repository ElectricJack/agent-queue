...
T = TypeVar("T", bound="ProviderRerouteUndoBody")


@_attrs_define
class ProviderRerouteUndoBody:
    """``POST /api/providers/reroute/undo`` (D16): a batch or tasks.

    Attributes:
        batch_id (None | str | Unset):
        task_id (list[str] | None | Unset):
        force (bool | None | Unset):
    """

    batch_id: None | str | Unset = UNSET
    task_id: list[str] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_task_id(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                task_id_type_0 = cast(list[str], data)
        ...
        provider_reroute_undo_body = cls(
            batch_id=batch_id,
            task_id=task_id,
            force=force,
        )

        provider_reroute_undo_body.additional_properties = d
        return provider_reroute_undo_body
