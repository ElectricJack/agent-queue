...
T = TypeVar("T", bound="TaskChildrenRequest")


@_attrs_define
class TaskChildrenRequest:
    """
    Attributes:
        task_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_children_request.additional_properties = d
        return task_children_request
